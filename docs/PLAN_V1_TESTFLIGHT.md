...
| 10 | EAS submit completion: fill ascAppId/appleTeamId (record exists from #4b); **API-key rotation with sequencing** — keep `tagit-hack-2026-key` valid until final builds of BOTH platforms carry the new key, then revoke | `3914…9867` | **Artem**+SUDO | 07-21 |
